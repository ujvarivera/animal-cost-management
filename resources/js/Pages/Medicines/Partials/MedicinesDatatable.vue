<template>
    <DataTable v-model:filters="filters" :value="medicines" paginator :rows="5" 
        ...
        <Column header="Módosítás" v-if="permissions.manage">
            <template #body="medicine">
                <ButtonLink :href="route('medicines.edit', medicine.data)" class="bg-orange-800 hover:bg-orange-700">
...
const { medicines, permissions } = defineProps({
    medicines: Array,
    permissions: Array
})
