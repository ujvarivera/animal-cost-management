<template>
    <DataTable v-model:filters="medicalRecordsFilters" :value="animalMedicalRecords" paginator :rows="5" 
        ...
        <template #footer> Összes: {{ animalMedicalRecords ? animalMedicalRecords.length : 0 }} vizsgálat. </template>
    </DataTable>
</template>
...
import { isAdmin, changeSuppliableType, hufCurrency } from '@/utils/utils'
