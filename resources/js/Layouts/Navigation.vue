<template>
    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <nav-link :href="route('animaltypes.index')" :active="route().current('animaltypes.index')">
                <template #icon>
            ...
            <nav-link :href="route('medical-records.index')" :active="route().current('medical-records.index')">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <nav-link :href="route('medicines.index')" :active="route().current('medicines.index')">
                <template #icon>
            ...
            <nav-link :href="route('suppliers.index')" :active="route().current('suppliers.index')">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <nav-link :href="route('supplies.index')" :active="route().current('supplies.index')">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
